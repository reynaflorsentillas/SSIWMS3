...
<html>
	...
	<body>
		...
		<div id="edit-retrieval" class="content scaffold-edit" role="main">
			...
			<div class="nav" role="navigation">
						...
						<fieldset class="buttons">
							...
							<g:link class="btn btn-default btn-sm" aria-label="Left Align" action="create"><g:message code="default.new.label" args="[entityName]" /></g:link>
							<h3></h3>
						</fieldset>
				</div>
		</div>
		...
		<g:if test="${flash.message}">
			...
			<g:form url="[resource:retrievalInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${retrievalInstance?.version}" />
				<fieldset class="form">
