...
<div class = "row">
	<div class = "col-sm-6 ">
		<div class="fieldcontain ${hasErrors(bean: reportInstance, field: 'reportDate', 'error')} required">
			...
			<calendar:datePicker name="reportDate" defaultValue="${new Date()}" value="${reportInstance?.reportDate}"/>
						...
						<div class = "col-sm-3 ">
							<div class="fieldcontain ${hasErrors(bean: reportInstance, field: 'reportID', 'error')} required">
								<label for="reportID">
									...
									<g:field class="form-control" name="reportID" type="number" value="${reportInstance.reportID}" />
								<h3></h3>
							</div>
						</div>
					</div>
